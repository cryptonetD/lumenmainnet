...
Final structure of the destination directory should be like
    ...
    $HOME/.lumenx/cosmovisor/upgrades/v1.3.3/bin
...
If You do not want to build binary locally or have some problems with that - You can just download it on Your linux system from [here](https://github.com/cryptonetD/lumenx/releases/download/v1.3.3/lumenxd)
...
Copy instruction should be as:
    ...
    cp <Your source folder>/lumenxd $HOME/.lumenx/cosmovisor/upgrades/v1.3.3/bin/.
